...
Backup Time: 2024-04-25 13:17:08
*/
...
INSERT INTO `bookmanagesys`.`book` (`id`,`bookname`,`total`,`putaway`,`surplus`) VALUES (9, '高等数学2', 11, '2018-08-01', 0),(10, 'Java', 12, '2019-08-10', 0),(11, 'java精彩编程200例', 13, '2018-09-08', 0),(12, '高  等教 育', 14, '2018-08-01', 0),(13, 'java从入门到精通', 15, '2017-09-08', 0),(14, 'java从入门到精通', 15, '2017-09-08', 0),(15, '商务英语', 12, '2018-10-08', 0),(16, '计算机入门', 13, '2018-11-08', 0),(17, '大学英语', 8, '2018-10-08', 0),(18, '计算机', 4, '2017-11-08', 0),(19, '入门到精通', 2, '2019-09-17', 0),(20, '高等教育', 2, '2018-08-01', 0),(21, 'MTML', 1, '2018-08-01', 0),(22, '小猪佩奇', 8, '2024-04-25', 1);
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `bookmanagesys`.`borrowrecord` WRITE;
DELETE FROM `bookmanagesys`.`borrowrecord`;
INSERT INTO `bookmanagesys`.`borrowrecord` (`id`,`bookid`,`userid`,`borrowdate`,`backdate`,`state`) VALUES (10004, 8, 8, '2019-09-01', '2019-10-01', '已还'),(10006, 9, 9, '2019-09-01', '2019-10-01', '已还'),(10008, 10, 10, '2019-09-01', '2019-10-01', '已还'),(10010, 11, 11, '2019-09-01', '2019-10-01', '已还'),(10014, 12, 12, '2019-09-01', '2019-10-01', '已还'),(10016, 13, 13, '2019-09-01', '2019-10-01', '已还'),(10018, 14, 14, '2019-09-01', '2019-10-01', '已还'),(10020, 15, 15, '2019-09-01', '2019-10-01', '已还'),(10022, 16, 16, '2019-09-01', '2019-10-01', '已还'),(10024, 17, 17, '2019-09-01', '2019-10-01', '已还'),(10026, 18, 18, '2019-09-01', '2019-10-01', '已还'),(10027, 22, 19, '2024-04-25', '2024-05-25', '已还');
UNLOCK TABLES;
COMMIT;
BEGIN;
LOCK TABLES `bookmanagesys`.`user` WRITE;
DELETE FROM `bookmanagesys`.`user`;
INSERT INTO `bookmanagesys`.`user` (`id`,`username`,`password`) VALUES (8, 'xiaoli', '666666'),(9, 'zhangyogn', '666666'),(10, 'zhangming', '666666'),(11, 'hexu', '666666'),(12, 'yang', '666666'),(13, 'wang', '666666'),(14, 'zhang', '666666'),(15, 'zhangzetian', '666666'),(16, 'wangyang', '666666'),(17, '郭州乐沙', '666666'),(18, '北冥有鱼', '123456'),(19, 'song', '123456');
UNLOCK TABLES;
COMMIT;
